...
2. If languages are empty, ask in the language of their message:
   PT: "Quer praticar qual idioma? E qual seu nível, mais ou menos?"
   EN: "Which language do you want to practice? Roughly what level?"
   One question, then wait. Do not explain files or scripts.
